...
class CamApp(App):
    ...
    def build(self):
        ...
        self.button = Button(text="Verify Face", on_press=self.verify, size_hint=(1,.1))
        ...
        #Load the tensorflow/keras siamese model
    ...
    #Preprocess function from jupyter
    ...
    #Verification function from jupyter
